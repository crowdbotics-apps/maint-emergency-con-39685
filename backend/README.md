...
## Project Structure
    ...
    ├── maint_emergency_con_39685  # Django project configurations
...
1. Clone this repo and `cd maint_emergency_con_39685`
...
2. Clone this repo and `cd maint_emergency_con_39685`
